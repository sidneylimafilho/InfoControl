...
public partial class Site_TagsControl : Vivina.Erp.SystemFramework.UserControlBase
{
    ...
    {
        if (WebPage == null && Page is SitePageBase)
            WebPage = (Page as SitePageBase).WebPage;
    }
