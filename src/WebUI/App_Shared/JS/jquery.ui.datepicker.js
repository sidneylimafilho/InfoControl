...
(function ($) { // hide the namespace
    ...
    function Datepicker() {
        ...
        this._defaults = { // Global defaults for all the date picker instances
            ...
            yearRange: 'c-5:c+10', // Range of years to display in drop-down,
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachments: function (input, inst) {
            ...
            if (showOn == 'button' || showOn == 'both') { // pop-up date picker when button clicked
				...
				$('<img/>').addClass(this._triggerClass).
					attr({ src: buttonImage, alt: buttonText, title: buttonText, style: "cursor : pointer" }) : // mexer aqui para alterar posição da imagem do calendário
        ...
        _checkOffset: function (inst, offset, isFixed) {
			...
			Math.abs(offset.top + dpHeight - viewHeight) : 0);
