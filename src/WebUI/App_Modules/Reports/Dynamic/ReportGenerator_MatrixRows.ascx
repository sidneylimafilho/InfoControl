<%@ Control Language="C#" Inherits="ReportGenerator_MatrixRows" CodeBehind="ReportGenerator_MatrixRows.ascx.cs" %>
<table cellspacing="10" cellpadding="0" width="100%" border="0">
    <tr>
        ...
        <td align="left" valign="middle">
            <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources: Resource, SelectRowsInReportDescription %>" />
        </td>
        <td align="left" valign="middle" style="padding-right: 10px; width: 1%">
            <h1>
                3</h1>
        ...
        <td align="left" valign="middle">
            <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources: Resource, SelectOrderOfRowsInReportDescription %>" />
        </td>
    </tr>
    <tr>
        ...
        <td style="text-align: center; width: 50%;" colspan="2">
            <img id="btnSobeTela3" src="../../App_Themes/GlassCyan/arrow_up.gif" border="0" name="incluir"
                style="cursor: pointer;" onclick="MoveUpColumn()" />&nbsp;&nbsp;&nbsp;
            <img id="btnDesceTela3" src="../../App_Themes/GlassCyan/arrow_down.gif" border="0"
                name="incluir" style="cursor: pointer;" onclick="MoveDownColumn()" />
        </td>
    </tr>
    <tr>
        <td valign="top" align="left" style="border: gray 1px solid;" colspan="2">
            <div id="placeHolderDisposition" style="overflow: auto; height: 150px; width: 100%;">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$ Resources: Resource, SelectColumnRequired %>"
...
<script type="text/javascript">
    ...
    function SelectColumn(column, name, value) {
        var listView = document.getElementById(columnPositionName);
        var hidden = document.getElementById("MatrixRowsHidden");
