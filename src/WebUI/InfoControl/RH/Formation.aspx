                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Nome">
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ErrorMessage="&nbsp;&nbsp;&nbsp;" ID="RequiredFieldValidator5"
                        ...
                        <asp:TemplateField HeaderText="Escolaridade">
                            <ItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ErrorMessage="&nbsp;&nbsp;&nbsp;" ID="RequiredFieldValidator1"
                                    runat="server" ControlToValidate="cboEducationLevel" CssClass="cErr21" ValidationGroup="Salvar">&nbsp;</asp:RequiredFieldValidator>
                            </ItemTemplate>
                        </asp:TemplateField>
