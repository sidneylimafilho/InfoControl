<%@ Page EnableEventValidation="false" Language="C#" MasterPageFile="~/infocontrol/Default.master"
    AutoEventWireup="true" Inherits="Company_RH_Formation_Sector"
    Title="Untitled Page" Codebehind="Sector.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
            ...
            <td class="center">
                ...
                <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" EditIndex="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Área de Trabalho">
                            <ItemTemplate>
                                <asp:DropDownList ID="cboSectorGroup" runat="server" DataSourceID="odsSectorGroup"
                                    SelectedValue='<%#Bind("SectorGroupId") %>' DataTextField="Name" DataValueField="SectorGroupId"
    ...
    <VFX:BusinessManagerDataSource ID="odsSectorGroup" runat="server" ConflictDetection="CompareAllValues"
        SelectMethod="GetAllSectorGroup" TypeName="Vivina.Erp.BusinessRules.HumanResourcesManager"
