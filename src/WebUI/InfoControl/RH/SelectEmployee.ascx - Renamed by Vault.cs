...
public partial class App_Shared_SelectEmployee : Vivina.Erp.SystemFramework.UserControlBase
{
    ...
    protected void txtEmployee_TextChanged(object sender, EventArgs e)
    {
        ...
        if (txtEmployee.Text.Contains("|"))
        {
            ...
            _employee = _employeeManager.RetrieveEmployeeByCpf(Page.Company.CompanyId, identification);
    ...
    public Int32? EmployeeId
    {
        ...
        set
        {
            ...
            if (value.HasValue)
            {
                var employeeManager = new EmployeeManager(this);
    ...
    public void ShowEmployee(Employee employee)
    {
        if (employee != null)
        {
            ...
            lnkEmployeeName.OnClientClick = "top.tb_show('Cadastro de Funcionário','RH/Employee.aspx?EmployeeId=" + employee.EmployeeId.ToString().Encrypt(EncodingType.BinHex) + "');return;";
