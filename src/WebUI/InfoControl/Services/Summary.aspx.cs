    ...
    public partial class Summary : Vivina.Erp.SystemFramework.PageBase
    {
        ...
        protected void grdCustomerCalls_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
                e.Row.Attributes["onclick"] = "top.$.LightBoxObject.show('CRM/CustomerCall.aspx?lightbox[iframe]=true&CustomerCallId=" + grdCustomerCalls.DataKeys[e.Row.RowIndex]["CustomerCallId"] + "');";
        }

        protected void grdServiceOrders_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
                e.Row.Attributes["onclick"] = "top.$.LightBoxObject.show('Services/ServiceOrder.aspx?lightbox[iframe]=true&ServiceOrderId=" + grdServiceOrders.DataKeys[e.Row.RowIndex]["ServiceOrderId"] + "');";
        }
