...
<body>
        ...
        <tr>
            <td id="left">
                ...
                <div id="menu">
                    ...
                    </a><a id="A1" onclick="top.tb_show('Agenda','Appointments.aspx?TB_iframe=true');"
                        href="javascript:;" runat="server" target="content" class="calendar" title="Agenda / Calendário">
                    </a><a id="A2" onclick="top.tb_show('Tarefas','Tasks.aspx?TB_iframe=true');" href="javascript:;"
                        runat="server" target="content" class="tasks" title="Tarefas"></a><a id="A4" href="http://vivina.com.br/site/Ajuda/InfoControl-ERP,33.aspx"
    ...
    <a id="fechar" href="../logoff.aspx?ReturnUrl=http://infocontrol.com.br" target="_top">&nbsp; </a>
    ...
    <img alt="Crie sua sugestão" style="position: absolute; top: 56px; right: 438px;
        cursor: pointer" src="../App_Themes/_global/user_message.gif" onclick="top.tb_show('Sugestões ou Erros','../InfoControl/CRM/CustomerCall.aspx?ModalPopUp=1');" />
    </form>
</body>
</html>
