...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <table class="cLeafBox21" width="100%">
        ...
        <tr class="middle">
            <td class="left">&nbsp; </td>
            <td class="center">
                <fieldset id="filter" class="closed"><legend><span id="filterLegend">Escolha o filtro
                    desejado:</span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<span id="exportLegend">Exportação:</span>
                </legend><div class="body" id="filterBody"><uc1:AccountSearch ID="ucAccountSearch"
                    runat="server" OnSelectedSearchAccountParameters="SearchAccount_SelectedParameters" />
                </div><div class="body" id="exportBody">
                    <table>
                        <tr>
                            <td><asp:RadioButton ID="rbtExportBoletu" GroupName="Export" Text="Boleto" runat="server" />
                                <asp:RadioButton ID="rbtExportAutomaticDebit" GroupName="Export" Text="Débito automatico"
                                    runat="server" /> </td>
                            <td>Conta bancária:<br />
                                <asp:DropDownList ID="cboAccount" runat="server" DataSourceID="odsAccount" DataTextField="ShortName"
                                    DataValueField="AccountId" CausesValidation="True"></asp:DropDownList>
                            </td>
                            <td>&nbsp;&nbsp;&nbsp;
                ...
                </div><span class="closeButton" id="closeFilter">&nbsp;</span> </fieldset>
                <br />
                <br />
                <br />
                <br />
                <br />
                <telerik:RadGrid ID="grdInvoices" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    DataSourceID="odsSearchInvoices" GridLines="Horizontal" OnSortCommand="grdInvoices_SortCommand"
                    AllowAutomaticDeletes="True" OnItemCommand="grdInvoices_ItemCommand" ShowFooter="True"
                    showgroupfooter="true" EnableTheming="True" ShowGroupPanel="True" OnItemDataBound="grdInvoices_ItemDataBound"
                    EnableViewState="False" PageSize="20" OnDataBound="grdInvoices_DataBound" AllowPaging="True">
                    <MasterTableView GroupLoadMode="Client" ShowGroupFooter="true" AllowMultiColumnSorting="false"
                        ...
                        <Columns>
                            <telerik:GridBoundColumn DataField="DueDate" HeaderText="Vence Em" UniqueName="column"
                                ...
                                HeaderButtonType="TextButton" Resizable="False" ShowSortIcon="False"></telerik:GridBoundColumn>
                            <telerik:GridTemplateColumn UniqueName="TemplateColumn"></telerik:GridTemplateColumn>
                            <telerik:GridBoundColumn DataField="Description" HeaderText="Descrição" UniqueName="column1"
                                SortExpression="Description"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="CustomerName" HeaderText="Cliente" UniqueName="column2"
                                SortExpression="CustomerName"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Desc" HeaderText="Parcela" UniqueName="column4"
                                SortExpression="Desc"></telerik:GridBoundColumn>
                        ...
                        <EditFormSettings><PopUpSettings ScrollBars="None"></PopUpSettings></EditFormSettings>
                    </MasterTableView>
                    <GroupingSettings CaseSensitive="False" CollapseTooltip="" ExpandTooltip="" GroupByFieldsSeparator=""
                        ...
                        UnGroupTooltip="" /><GroupHeaderItemStyle Wrap="False" />
                    <ClientSettings EnablePostBackOnRowClick="False" AllowDragToGroup="True" EnableRowHoverStyle="True">
                        <Selecting AllowRowSelect="True" /><ClientEvents OnRowMouseOver="RowMouseOver" OnRowMouseOut="RowMouseOut" />
                    </ClientSettings>
                </telerik:RadGrid>
            </td>
            <td class="right">&nbsp; </td>
