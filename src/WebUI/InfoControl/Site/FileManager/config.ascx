...
<script runat="server">
	 ...
	 */
        ...
        public override bool CheckAuthentication()
        {
            ...
            return Page.User.IsAuthenticated;
        }
	 ...
	 */
        ...
        public override void SetConfig()
        {
            ...
            BaseUrl = this.Page.Company.GetHomePath();
            ...
            string name = Page.Company.LegalEntityProfile.Website.RemoveDpnInUrl();
            ResourceType type = ResourceType.Add(String.IsNullOrEmpty(name) ? "1" : name); 
            type.Url = BaseUrl + "/";
            type.Dir = BaseDir; // == "" ? "" : BaseDir + "files/";
            type.MaxSize = 0;
            type.AllowedExtensions = new[] { "7z", "aiff", "asf", "aspx", "asmx", "avi", "bmp", "css", "csv", "doc", "fla", "flv", "gif", "gz", "gzip", "htm", "html", "ico", "jpeg", "jpg", "js", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pack", "pdf", "png", "ppt", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xml", "zip" };
