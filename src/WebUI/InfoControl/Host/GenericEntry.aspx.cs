...
public partial class Host_Generico_Cadastro : Vivina.Erp.SystemFramework.PageBase
{
    ...
    protected void grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        {
            ShowMessage("Não foi possivel apagar o registro selecionado pois há outros registros associados!<br />");
        }
    ...
    protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
    {
            ...
            ((e.Row.RowState & DataControlRowState.Edit) == DataControlRowState.Normal))
        {
            ...
            if (e.Row.RowState != DataControlRowState.Edit)
            {
                ...
                (e.Row.Cells[i - 2].Controls[0] as LinkButton).Attributes["onclick"] = "return(confirm('O registro será excluido e não poderá mais ser recuperado, deseja realmente efetuar a operação?'))";
            }
        }
