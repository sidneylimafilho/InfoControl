...
namespace InfoControl.Net.Mail.Mime
{
    ...
    public class MimeParser
    {
        ...
        public MimeParser(byte[] msg)
        {
            ...
            _bcc = ParseAddress(m_Headers, "BCC:");
            _from = ParseHeaderField("FROM:", m_Headers);
            _to = ParseAddress(m_Headers, "TO:");
            _cc = ParseAddress(m_Headers, "CC:");

            _importance = ParseHeaderField("IMPORTANCE:", m_Headers);
            _messageID = ParseHeaderField("MESSAGE-ID:", m_Headers);
            _subject = ParseHeaderField("SUBJECT:", m_Headers);
            _priority = ParseHeaderField("X-Priority:", m_Headers);

            _contentType = ParseContentType(m_Headers);
        }
        ...
        {
            get { return Core.CanonicalDecode(_subject); }
        }
