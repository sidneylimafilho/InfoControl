...
namespace InfoControl.Net.Mail.SMTP.Server
{	
	...
	/// <summary>
	/// Represents the method that will handle the ValidateMailFrom event for Pop3Server.
	/// </summary>
	/// <param name="sender">The source of the event. </param>
	...
	/// <summary>
	/// Represents the method that will handle the ValidateMailTo event for Pop3Server.
	/// </summary>
	/// <param name="sender">The source of the event. </param>
	...
	/// <summary>
	/// Represents the method that will handle the ValidateMailboxSize event for Pop3Server.
	/// </summary>
	/// <param name="sender">The source of the event. </param>
	...
	/// <summary>
	/// Represents the method that will handle the StoreMessage event for Pop3Server.
	/// </summary>
	/// <param name="sender">The source of the event. </param>
