...
{
    public class BematechNaoFiscal : EcfProviderBase
    {
        public int MyProperty { get; set; }
        double total = 0;
        public BematechNaoFiscal()
        {
        }

        #region Metodos de Acesso ao Registry  "throw new Exception"
        ...
        public override void AbreCupom(
            ...
            string numeroCupom)
        {
            ImprimeTexto(companyName + "\n", "", false, false, false, false);
            ImprimeTexto(addressName.PadRight(20, ' ') + "\n", "", false, false, false, false);
            ImprimeTexto(neighborhood + " - " + city + " - " + stateId + "\n", "", false, false, false, false);
            ImprimeTexto("CNPJ:                 " + cpfCnpj + "\n", "", false, false, false, false);
            ImprimeTexto("\n", "", false, false, false, false);
            ImprimeTexto("------------------------------------\n", "", false, false, false, false);
            ImprimeTexto("      COMPROVANTE NÃO FISCAL       \n", "", false, false, false, false);
            ImprimeTexto(DateTime.Now.ToString("dd/MM/yyyy hh24:mm") + "         COD: " + numeroCupom.PadLeft(4, '0') + "\n", "", false, false, false, false);
            ImprimeTexto("------------------------------------\n", "", false, false, false, false);
            ImprimeTexto("COD          DESCRICAO\n", "", false, false, false, false);
            ImprimeTexto("QTD         UNIT(R$)    VALOR ITEM\n", "", false, false, false, false);
            ImprimeTexto("------------------------------------\n", "", false, false, false, false);
        }
        ...
        public override void VendeItem(System.String codigo, System.String descricao, System.String aliquota, System.String tipoQuantidade, int quantidade, int casasDecimais, double valorUnitario, System.String tipoDesconto, System.String desconto)
        {
            ...
            ImprimeTexto(codigo.PadRight(10, ' ') + " " + descricao + "\n", "", false, false, false, false);
            ImprimeTexto((quantidade + " x " + valorUnitario.ToString("##,###,#0.00").PadLeft(10, ' ') + " = " + (quantidade * valorUnitario).ToString("##,###,#0.00").PadLeft(10, ' ')).PadLeft(36, ' ') + "\n", "", false, false, false, false);
        }
            ...
            double valorAcrescimoDesconto)
        {
            ...
            ImprimeTexto(texto.PadRight(16, ' ') + valorAcrescimoDesconto.ToString("R$ ##,###,#0.00").PadLeft(20, ' ') + "\n", "", false, false, false, false);
            ImprimeTexto("TOTAL".PadRight(18, ' ') + total.ToString("R$ ##,###,#0.00").PadLeft(18, ' ') + "\n", "", false, false, false, false);
        }

        public override void EfetuaFormaPagamento(string formaPagamento, double valorFormaPagamento)
        {
            ImprimeTexto(("Pagou em " + formaPagamento).PadRight(20, ' ') + valorFormaPagamento.ToString("R$ ##,###,#0.00").PadLeft(16, ' ') + "\n", "", false, false, false, false);
        }
        ...
        {            
            ...
            {
                ImprimeTexto("------------------------------------\n", "", false, false, false, false);
                ImprimeTexto(mensagem, "", false, false, false, false);
                ImprimeTexto("\n------------------------------------", "", false, false, false, false);
                ImprimeTexto("\n\n\n\n\n\n\n\n\n\n", "", false, false, false, false);
            }
        }
        ...
        public override void FechaCupom(
            ...
            string mensagem)
        {
            ImprimeTexto("TOTAL".PadRight(20, ' ') + total.ToString("R$##,###,#0.00").PadLeft(20, ' ') + "\n", "", false, false, false, false);
            ImprimeTexto(formaPagamento.PadRight(20, ' ') + valorPago.ToString("R$##,###,#0.00").PadLeft(20, ' ') + "\n", "", false, false, false, false);
        ...
        #endregion
        #region Metodos de Acesso A Leitura da Memoria Fiscal "throw new Exception"
        ...
        #endregion
        #region Outras
        public override void AbrePortaSerial() { scripts.Add("Ecf.IniciaPorta('LPT1');"); }

        public override void FechaPortaSerial() { scripts.Add("Ecf.FechaPorta();"); }
        ...
        public override void ImprimeTexto(string texto, string fonte, bool italic, bool underline, bool extended, bool negrito)
        {
            scripts.Add("Ecf.FormataTX('" + texto.Replace("\n", "\\n") + "', 3, " + Convert.ToInt32(italic) + ", " + Convert.ToInt32(underline) + ", " + Convert.ToInt32(extended) + ", " + Convert.ToInt32(negrito) + ");");
        }


        public override string Render()
        {            
            return "<object classid=\"clsid:310DBDAC-85FF-4008-82A8-E22A09F9460B\" id=\"Ecf\" width=\"0\" height=\"0\"></object>" +
                    "<script type=\"text/javascript\">var Ecf = document.getElementById('Ecf');" + String.Join("", scripts.ToArray()) + "</script>";            
        }
