...
namespace InfoControl.Data
{
    ...
    public class DataReader : IDataReader, IEnumerable
    {
        ...
        /// </summary>
        /// <param name="dr"></param>
        public DataReader(IDataReader dr)
        {
            _dataReader = dr;
        ...
        public DataReader(IDataReader dr, int recordCount)
        {
            _dataReader = dr;
        ...
        */
        ...
        {
            return (GetDataReaderEnumerator());
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DataReaderEnumerator GetDataReaderEnumerator()
        {
